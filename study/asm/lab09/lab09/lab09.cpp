...
void				lab09Func(HWND hWnd); // my function
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_LAB09, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LAB09));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_LAB09);
